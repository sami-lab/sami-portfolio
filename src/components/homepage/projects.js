...
export default function Projects() {
  ...
  const projects = showMore ? user.projects : user.projects.slice(0, 6);
  return (
    <Grid container direction="column" alignItems="center" className={classes.root}>
                  ...
                  <Grid container justifyContent="space-between" alignItems="center">
                    ...
                    <Grid item>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
                        {p.github && (
                          <a href={p.github} target="_blank" style={{ textDecoration: 'none' }}>
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              fill="none"
                              stroke="currentColor"
                        ...
                        {p.website && (
                          <a href={p.website} target="_blank" style={{ textDecoration: 'none' }}>
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              fill="none"
                              stroke="currentColor"
                    ...
                    {p.technologies.map((t, i) => (
                      <Typography
                        ...
                        style={{
                          ...
                          fontSize: '12px',
                          color: '#8892b0',
                          marginRight: p.technologies.length === i + 1 ? 0 : '15px',
                        }}
                      >
                        {t}
                      </Typography>
      ...
      {/* show more */}
      <Grid item container justifyContent="center" style={{ marginTop: '80px' }}>
        <Button
          data-aos="fade-up"
          data-aos-duration="2000"
